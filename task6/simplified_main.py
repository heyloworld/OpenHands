...
import logging
import argparse
from src.simplified_data_loader import DataLoader
...
if __name__ == "__main__":
    ...
    parser.add_argument("--sample_size", type=int, default=1000, help="Number of samples to use. If None, use all data.")
